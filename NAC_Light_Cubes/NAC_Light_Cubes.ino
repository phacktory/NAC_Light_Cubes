...
int numReads = 3;                     // Audio data averaging. Set to 1 for NO averging
const unsigned long loop_dlay = 0;    // loop delay to slow down display update rate

// Cube order for the noise[] and gain[] arrays below: 
// {Violet, Indigo, Blue, Green, Yellow, Orange, Red}

const int noise[] = {130, 110, 110, 110, 110, 125, 135};  // Set this to the line noise magnitude 
                                                          // on for each band. 
                                                          // To determine line noise set each value
                                                          // to zero and open serial port while 
                                                          // on spectrum mode. Do not play audio.

const float gain[] = {1.2, 1.0, 1.2, 0.8, 1.0, 1.5, 2.5}; // Gain for each band. Increase 
